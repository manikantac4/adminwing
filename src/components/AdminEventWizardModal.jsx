...
const DESIGN_TEMPLATES = [
  {
    id: "ai-future",
    name: "Template 1 — AI Future (Dark Obsidian)",
    badge: "RECOMMENDED",
    color: "from-amber-500 to-yellow-600",
    bgPreview: "bg-slate-950 border-amber-500/40 text-white",
    desc: "Glow effects, AI illustrations, champagne gold accents, obsidian dark surfaces.",
  },
  {
    id: "cyberpunk-neon",
    name: "Template 2 — Cyberpunk Neon Matrix",
    badge: "POPULAR",
    color: "from-pink-500 to-cyan-400",
    bgPreview: "bg-black border-pink-500/40 text-pink-300",
    desc: "Neon pink & cyan matrix grid, scanlines, animated glowing borders.",
  },
  {
    id: "space-odyssey",
    name: "Template 3 — Space Odyssey Galaxy",
    badge: "CREATIVE",
    color: "from-indigo-600 to-blue-700",
    bgPreview: "bg-slate-950 border-indigo-500/40 text-indigo-200",
    desc: "Deep space galaxy dark, floating orbital elements, cosmic nebula vibes.",
  },
  {
    id: "corporate-pro",
    name: "Template 4 — Corporate Professional",
    badge: "ENTERPRISE",
    color: "from-slate-800 to-blue-900",
    bgPreview: "bg-white border-slate-300 text-slate-900",
    desc: "Clean navy blue & white layout, executive cards, professional typography.",
  },
  {
    id: "university-campus",
    name: "Template 5 — University Campus",
    badge: "ACADEMIC",
    color: "from-amber-600 to-yellow-700",
    bgPreview: "bg-amber-50 border-amber-200 text-amber-900",
    desc: "Bright academic style, campus event banners, student challenge cards.",
  },
  {
    id: "gaming-arena",
    name: "Template 6 — Gaming RGB Arena",
    badge: "HIGH ENERGY",
    color: "from-red-600 to-amber-500",
    bgPreview: "bg-zinc-950 border-red-500/50 text-red-500",
    desc: "High energy RGB lighting, esports tournament cards, bold headers.",
  },
  {
    id: "modern-saas",
    name: "Template 7 — Modern SaaS Startup",
    badge: "TRENDING",
    color: "from-teal-500 to-emerald-600",
    bgPreview: "bg-slate-900 border-teal-500/40 text-teal-300",
    desc: "Startup platform dashboard aesthetic, rounded cards, clean progress indicators.",
  },
  {
    id: "minimal-premium",
    name: "Template 8 — Minimal Premium Gold",
    badge: "LUXURY",
    color: "from-slate-900 to-[#18191B]",
    bgPreview: "bg-white border-slate-300 text-slate-900",
    desc: "Luxury minimalist white, black & gold serif typography, micro-interactions.",
  },
  {
    id: "creative-innovation",
    name: "Template 9 — Creative Innovation",
    badge: "VIBRANT",
    color: "from-purple-600 to-pink-600",
    bgPreview: "bg-purple-950 border-purple-500/40 text-pink-200",
    desc: "Bright gradient headers, floating creative shapes, innovation tracks.",
  },
  {
    id: "premium-3d",
    name: "Template 10 — Premium 3D Experience",
    badge: "3D SPATIAL",
    color: "from-amber-500 via-yellow-400 to-amber-600",
    bgPreview: "bg-zinc-900 border-amber-500/50 text-amber-300",
    desc: "High-end 3D spatial cards, cinematic lighting, interactive storytelling layout.",
  },
];
